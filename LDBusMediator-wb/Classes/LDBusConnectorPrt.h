 ...
 * 当前业务组件可导航的URL询问判断
 */
-(BOOL)bus_canOpenURL:(nonnull NSURL *)URL;
 ...
 */
- (nullable UIViewController *)bus_connectToOpenURL:(nonnull NSURL *)URL params:(nullable NSDictionary *)params;
 ...
 */
- (nullable id)bus_connectToHandleProtocol:(nonnull Protocol *)servicePrt;
